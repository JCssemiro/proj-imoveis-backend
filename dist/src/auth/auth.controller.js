...
let AuthController = class AuthController {
    ...
    register(dto) {
        if (dto.type === 'broker') {
            return this.auth.registerBroker(dto);
        }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Retorna access_token e dados do usuário' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'E-mail enviado (ou sucesso silencioso)' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
